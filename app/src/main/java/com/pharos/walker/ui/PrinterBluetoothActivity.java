...
public class PrinterBluetoothActivity extends Activity {
    private static final String TAG =PrinterBluetoothActivity.class.getSimpleName();
    /**
     * Member fields
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_printer_bluetooth);
        Log.e(TAG, "On Create");
    ...
    private void initBluetooth(){
        ...
        if (mBluetoothAdapter == null) {
           ToastUtils.showShort(this, "Bluetooth is not supported by the device");
        } else {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothDevice.ACTION_FOUND.equals(action)) {
                ...
                if (bluetooth_state==BluetoothAdapter.STATE_OFF) {//关闭
                    ToastUtils.showShort(getString(R.string.bluetooth_is_close));
                    finish();
                }
