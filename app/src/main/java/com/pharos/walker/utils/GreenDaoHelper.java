...
//        mDaoSession = mDaoMaster.newSession(IdentityScopeType.None);//解决更新缓存问题
    ...
    public static class MyOpenHelper extends DaoMaster.OpenHelper {
        ...
        public void onUpgrade(Database db, int oldVersion, int newVersion) {
            ...
            },  UserBeanDao.class, PlanEntityDao.class, SubPlanEntityDao.class, UserTrainRecordEntityDao.class, EvaluateEntityDao.class, TrainDataEntityDao.class, ActivationCodeBeanDao.class);
        }
    }
