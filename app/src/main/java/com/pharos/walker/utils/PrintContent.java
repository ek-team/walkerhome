...
public class PrintContent {
       ...
       * @return
       */
      public static Vector<Byte> getReceipt(ArrayList<String> arrayList,String path) {
            ...
            // 打印文字
            esc.addText(arrayList.get(0) + "\n");
            esc.addText(arrayList.get(1) + "\n");
            //打印并换行
...
//            esc.addText("姓名:张三\n");
            // 打印文字
            esc.addText(arrayList.get(2) + "\n");
            esc.addText(arrayList.get(3) + "\n");
            esc.addText(arrayList.get(4) + "\n");

            esc.addPrintAndLineFeed();
            esc.addText(arrayList.get(9) + "\n");
            esc.addText(arrayList.get(6) + "\n");
            esc.addText(arrayList.get(7) + "\n");
            esc.addText(arrayList.get(8) + "\n");
//            // 设置打印左对齐
//            esc.addSelectJustification(EscCommand.JUSTIFICATION.LEFT);
//            esc.addText("居左");
//            esc.addPrintAndLineFeed();
...
//            esc.addText("测试完成!\r\n");
      ...
      public static Vector<Byte> getLabel() {
            ...
            Bitmap b = BitmapFactory.decodeResource(MyApplication.getInstance().getResources(), R.drawable.gprinter);
            // 绘制图片
      ...
      public static Vector<Byte> getCPCL() {
            ...
            Bitmap bitmap = BitmapFactory.decodeResource(MyApplication.getInstance().getResources(), R.drawable.gprinter);
